...
const ALERT_META: Record<string, { icon: React.ReactNode; label: string; color: string }> = {
  SPEED_LIMIT:   { icon: <Zap className="w-3.5 h-3.5" />,        label: 'Speed Limit',    color: 'text-amber-400 bg-amber-500/10 border-amber-500/20' },
  GEOFENCE_EXIT: { icon: <MapPin className="w-3.5 h-3.5" />,      label: 'Geofence Exit',  color: 'text-purple-400 bg-purple-500/10 border-purple-500/20' },
  IGNITION_ON:   { icon: <Zap className="w-3.5 h-3.5" />,        label: 'Ignition ON',    color: 'text-emerald-400 bg-emerald-500/10 border-emerald-500/20' },
  IGNITION_OFF:  { icon: <Zap className="w-3.5 h-3.5" />,        label: 'Ignition OFF',   color: 'text-slate-400 bg-slate-500/10 border-slate-500/20' },
  SIGNAL_LOST:   { icon: <WifiOff className="w-3.5 h-3.5" />,    label: 'Signal Lost',    color: 'text-red-400 bg-red-500/10 border-red-500/20' },
};
